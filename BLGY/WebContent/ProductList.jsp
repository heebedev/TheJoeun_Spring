...
<div class="page">
		...
		<nav>
			<ul>
				<li><input type="button" value="등록 상품 목록" style="background-color: brown; color:white;"></li>
			</ul>
		</nav>
		...
		<tr>
			<td style="width: 200px; height:200px; padding-left:30px; "><a href="./productDetail.bill?prdseq=${dto.prdseq}&myseq=<jsp:getProperty property="userseq" name="userdata"/>"><img src="${dto.image1}" width= "200px" height="200px" style="border: solid gray 1px; border-radius:4px;"></a></td>
